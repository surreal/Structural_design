...
public class PenetrationCategory_SubCategoryTwo extends PenetrationCategory {

    public PenetrationCategory_SubCategoryTwo(){
        resetValues();
        setValues();
        setAllAdapters();
    }
    ...
    private void setValues() {
        if (savedVersionTitle != null) {
            ...
            id_100_value = sqlLocal.getRelevantDoubleValue(cursor, null, DBModel.COLUMN_VAL_ID_100);
    ...
    public ArrayList<StructuralDesignModel> initModels(boolean isForSetValuesModels) {
        if (isForSetValuesModels){
            ...
            valuesModels.add(new StructuralDesignModel(100, "מימדי עמוד מלבני", "גודל עמוד בכיוון X", "[cm]", id_100_value+"", 0));
            valuesModels.add(new StructuralDesignModel(101, "מימדי עמוד מלבני", "גודל עמוד בכיוון Y", "[cm]", id_101_value+"", 0));
            ...
            valuesModels.add(new StructuralDesignModel(25, "מיקום העמוד", "β", "", id_25_value+"", 0));
            ...
            resultModels.add(new StructuralDesignModel(2000, "היקף קו היקפי", "сm", "", mathId_2000(1), 0));
    ...
    private String mathId_108() {
        try {
            firstMathPart = (Math.min(2 * id_100_value, Math.min(id_101_value , 3 * id_7_value)) + Math.min(id_100_value, 3 * id_7_value)) * 2;
            secondMathPart = (Math.min(2 * id_101_value,Math.min(id_100_value, 3 * id_7_value)) + Math.min(id_101_value, 3 * id_7_value)) * 2;
            id_108_value = id_101_value > id_100_value ? firstMathPart : firstMathPart;
            Log.d("checkMath", "mathId_108() -> id_108_value == " + id_108_value +"; id_36_value == " + id_36_value + "; id_37_value == " + id_37_value + "; id_47_value == " + id_47_value);
    ...
    private void insertToDB() {
        sqLiteDatabase.execSQL(sqlHelper.insertPenetration_SQL(DialogHelper.input, moduleActiveId, categoryActiveId, subCategoryActiveId,
                ...
                id_100_value, id_101_value,1,1,1,1,1, id_22_value, id_23_value,
    ...
    private void updateDB() {
        sqLiteDatabase.execSQL(sqlHelper.updateCL_SQL(
                ...
                id_100_value, id_101_value, 1, 1, 1, 1, 1,
    ...
    public void valueNumberChangedListener(double valueItemNumber, int valueItemId, int spinnerPosition) {
        ...
        switch (valueItemId) {
            case 1:
                ...
                setRelevantResultItem_value(31, mathId_31(1), "");
                ...
                setRelevantResultItem_value(2000, mathId_2000(1), "");
