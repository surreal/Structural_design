...
public class PenetrationCategory_SubCategoryOne extends PenetrationCategory {

    public PenetrationCategory_SubCategoryOne(){
        resetValues();
        setValues();
        setAllAdapters();
    }
    ...
    private void setValues() {
        if (savedVersionTitle != null) {
            ...
            id_108_value = sqlLocal.getRelevantDoubleValue(cursor, null, DBModel.COLUMN_VAL_ID_108);
    ...
    public ArrayList<StructuralDesignModel> initModels(boolean isForSetValuesModels) {
        if (isForSetValuesModels){
            ...
            valuesModels.add(new StructuralDesignModel(108, "היקף עומס", "U,0", "[cm]", id_108_value+"", 0));
            ...
            resultModels.add(new StructuralDesignModel(51, "בדיקת מרחק משיקי תקין בהיקף קריטי ראשון", "St<Stmax", "-", mathId_51(), 0));
