...
public class PenetrationCategory_SubCategorySix extends PenetrationCategory {

    public PenetrationCategory_SubCategorySix(){
        resetValues();
        setValues();
        setAllAdapters();
    }
    ...
    private ArrayList<StructuralDesignModel> initModels(boolean isForSetValuesModels) {
        if (isForSetValuesModels){
            ...
            resultModels.add(new StructuralDesignModel(2000, "היקף קו היקפי", "сm", "", mathId_2000(0.75), 0));
    ...
    private void insertToDB() {
        sqLiteDatabase.execSQL(sqlHelper.insertPenetration_SQL(DialogHelper.input, moduleActiveId, categoryActiveId, subCategoryActiveId,
                ...
                id_9_value, id_10_value, id_15_value, id_16_value, 1,1,1,1,1,1,1,
                id_22_value, id_23_value,
    ...
    public String mathId_031() {
        id_31_value = id_108_value + (Math.PI * id_7_value);
    ...
    public void valueNumberChangedListener(double valueItemNumber, int valueItemId, int spinnerPosition) {
        ...
        switch (valueItemId) {
            case 1:
                ...
                setRelevantResultItem_value(2000, mathId_2000(0.75), "");
