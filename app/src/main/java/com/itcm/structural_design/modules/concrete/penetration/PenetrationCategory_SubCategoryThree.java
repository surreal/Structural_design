...
public class PenetrationCategory_SubCategoryThree extends PenetrationCategory {

    public PenetrationCategory_SubCategoryThree(){
        resetValues();
        setValues();
        setAllAdapters();
    }
    ...
    private ArrayList<StructuralDesignModel> initModels(boolean isForSetValuesModels) {
        if (isForSetValuesModels){
            ...
            valuesModels.add(new StructuralDesignModel(103, "מימדי עמוד", "קוטר עמוד", "[cm]", id_103_value+"", 0));
    ...
    private String mathId_108() {
        try {
            id_108_value = 2 * Math.PI * id_103_value;
