...
public class BendingToleranceCategory_SubCategoryTwo extends BendingToleranceCategory {

    public BendingToleranceCategory_SubCategoryTwo(){
        resetValues();
        setValues();
        setAllAdapters();
    }
    ...
    public void resetValues() {
        id_2_value = 30; id_1_value = 1; id_3_value = 1; id_4_value = 1; id_6_value = 1; id_7_value = 0;
        id_8_value = 30; id_9_value = 8.7; id_10_value = 400; id_11_value = 350; id_12_value = 1.7; id_13_value = 0.0012; id_14_value = 0.0015;
        id_1015_value = 0; id_20_value = 1; id_21_value = 1; id_1019_value = 1; id_1018_value = 1;
        ...
        id_1001_value = 1; id_1002_value = 1;
    ...
    private void setValues() {
        if (savedVersionTitle != null) {
            ...
            Log.d("checkSetValues", "cursor.moveToFirst() == " + cursor.moveToFirst());
            if (cursor.moveToFirst()) {
                ...
                id_1001_value = sqlLocal.getRelevantDoubleValue(cursor, null, DBModel.COLUMN_VAL_ID_1001);
                id_1002_value = sqlLocal.getRelevantDoubleValue(cursor, null, DBModel.COLUMN_VAL_ID_1002);
    ...
    public void tonOrKnBtnClicked() {
        setRelevantResultItem_value(1015, mathId_1015(), getRelevantSecondMeasuringUnit(1));
        setRelevantResultItem_value(1016, mathId_1016(), getRelevantSecondMeasuringUnit(1));
        setRelevantResultItem_value(1018, mathId_1018(), getRelevantSecondMeasuringUnit(1));
        setRelevantResultItem_value(1004, mathId_1004(), getRelevantSecondMeasuringUnit(1));
        setRelevantResultItem_value(1005, mathId_1005(), getRelevantSecondMeasuringUnit(1));
        setRelevantResultItem_value(1006, mathId_1006(), getRelevantSecondMeasuringUnit(1));
        ...
        setRelevantResultItem_value(48, mathId_48(), getRelevantSecondMeasuringUnit(0));
        ...
        setRelevantValueItemMeasuringUnit(70, getRelevantSecondMeasuringUnit(1));
//        if (isPitulSelected) setRelevantResultItem_value(80, mathId_80(), getRelevantSecondMeasuringUnit(1));
    ...
    private ArrayList<StructuralDesignModel> initModels(boolean isForSetValuesModels) {
        if (isForSetValuesModels) {
            ...
            valuesModels.add(new StructuralDesignModel(1001, "גובה אגף", "tf", "[cm]", id_1001_value+"", 0));
            valuesModels.add(new StructuralDesignModel(1002, "רוחב אגף", "bf", "", id_1002_value+"", 0));
...
//            }
            ...
            resultModels.add(new StructuralDesignModel(1015, "מומנט תסבולת מקסימלי", "Mcd,max", "[KNm]", mathId_1015(), 0));
            resultModels.add(new StructuralDesignModel(1016, "בדיקה מומנט תסבולת מקסימלי", "2*Mcd,max>Md", "[KNm]", mathId_1016(), 0));
            resultModels.add(new StructuralDesignModel(1017, "בדיקת מומנט התכן מול מומנט התסבולת", "Mcd>Md", "-", mathId_1017(), 0));
            resultModels.add(new StructuralDesignModel(1018, "מומנט תכן", "DMd", "[KNm]", mathId_1018(), 0));
            resultModels.add(new StructuralDesignModel(1019, "תוספת  זיון לחוץ", "As'_calc", "[cm²]", mathId_1019(), 0));
            resultModels.add(new StructuralDesignModel(1003, "בדיקת יחם גובה קורה לעובי אגף", "tf>0.1*h", "-", mathId_1003(), 0));
            resultModels.add(new StructuralDesignModel(1004, "מומנט תסבולת אגפים", "mf", "[KNm]", mathId_1004(), 0));
            resultModels.add(new StructuralDesignModel(1005, "מומנט תסבולת אגפים ללא הדופן", "Mfd", "[KNm]", mathId_1005(), 0));
            resultModels.add(new StructuralDesignModel(1006, "מומנט תסבולת דופן  ללא אגף", "MWd", "[KNm]", mathId_1006(), 0));
            resultModels.add(new StructuralDesignModel(20, "שטח חתך זיון מינימלי", "As,min", "[cm²]", mathId_20(), 0));
            resultModels.add(new StructuralDesignModel(1021, "יחס איזור לחוץ/מתוח", "ω", "-", mathId_1021(), 0));
            resultModels.add(new StructuralDesignModel(1007, "", "ωmwd", "-", mathId_1007(), 0));
            resultModels.add(new StructuralDesignModel(1008, "", "ω", "", mathId_1008(), 0));
            resultModels.add(new StructuralDesignModel(1022, "גובה אזור לחוץ", "x", "-", mathId_1022(), 0));
            resultModels.add(new StructuralDesignModel(1009, "", "ω", "", mathId_1009(), 0));
            resultModels.add(new StructuralDesignModel(1023, "זרוע שקול כוחות", "Z", "[сm]", mathId_1023(), 0));
            resultModels.add(new StructuralDesignModel(1024, "שטח זיון מתוח מחושב", "As'_calc", "[cm²]", mathId_1024(), 0));
            ...
            resultModels.add(new StructuralDesignModel(1031, "בדיקת שטח הזיון  המתוח בפועל מול הזיון המחושב", "As,act>As,calc", "-", mathId_1031(), 0));
...
//            }
    ...
    private void insertToDB() {
        sqLiteDatabase.execSQL(sqlHelper.insertBT_SQL(
    ...
    public String mathId_1003(){
        Log.d("checkMath", "mathId_1003 -> id_1001_value == " + id_1001_value + "; id_3_value == " + id_3_value);
        return id_1001_value > (id_3_value * 0.1) ? "חתך קמץ" : "יש לחשב לפי חתך מלבני";
    }

    public String mathId_1004(){
        id_1004_value = id_1002_value * id_1001_value * (id_7_value - 0.5 * id_1001_value) * id_9_value / 1000;
        Log.d("checkMath", "mathId_1004 -> id_1004_value == " + id_1004_value + "; id_1002_value == " + id_1002_value + "; id_1001_value == " + id_1001_value + "; id_7_value == " + id_7_value + "; id_9_value == " + id_9_value);
        return formatNumberDecimal(Double.parseDouble(getTonOrKnVal(id_1004_value))) + "";
    }

    public String mathId_1005(){
        id_1005_value = (id_1002_value - id_6_value) * id_1001_value * (id_7_value - 0.5 * id_1001_value) * id_9_value / 1000;
        Log.d("checkMath", "mathId_1005 -> id_1005_value == " + id_1005_value + "; id_1002_value == " + id_1002_value + "; id_6_value == " + id_6_value + "; id_1001_value == " + id_1001_value + "; id_7_value == " + id_7_value + "; id_9_value == " + id_9_value);
        return formatNumberDecimal(Double.parseDouble(getTonOrKnVal(id_1005_value))) + "";
    }

    public String mathId_1006(){
        id_1006_value = id_1015_value - id_1005_value;
        Log.d("checkMath", "mathId_1006 -> id_1006_value == " + id_1006_value + "; id_1015_value == " + id_1015_value + "; id_1005_value == " + id_1005_value);
        return formatNumberDecimal(Double.parseDouble(getTonOrKnVal(id_1006_value))) + "";
    }

    public String mathId_1007(){
        try {
            firstMathPart = 2 * (id_1015_value - id_1004_value) * 1000;
            ...
            id_1007_value = 1 - Math.pow(1-(firstMathPart / secondMathPart),0.5) < 0.1
                    ? 0.1
                    : Math.min(1 - Math.pow(1 - (firstMathPart / secondMathPart), 0.5), 0.4);
            Log.d("checkMath", "mathId_1007() -> try{} id_1007_value == " + id_1007_value + "; firstMathPart == " + firstMathPart + "; secondMathPart == " + secondMathPart);
            Log.d("checkMath", "mathId_1007() -> id_1007_value == " + id_1007_value + "; id_1015_value == " + id_1004_value + "; id_1004_value == " + id_1004_value + "; id_6_value == " + id_6_value + "; id_7_value == " + id_7_value + "; id_9_value == " + id_9_value);
            if (Double.isNaN(id_1007_value)) throw new NumberFormatException(NaN);
            return formatNumberDecimal(id_1007_value);
        } catch (ArithmeticException | NumberFormatException e){
            id_1007_value = Double.NaN;
            Log.d("checkMath", "mathId_1007() -> catch{} id_1007_value == " + id_1007_value);
            e.printStackTrace();
            return context.getString(R.string.not_valid_cut);
        }
    }

    public String mathId_1008(){
        try {
            firstMathPart = 2 * (id_1_value - id_1004_value) * 1000;
            secondMathPart = id_6_value * id_7_value * id_7_value * id_9_value;
            thirdMathPart = 2 * id_1_value * 1000;
            if (secondMathPart != 0) {
                id_1008_value = id_1004_value > id_1_value
                        ? 1 - (Math.pow(1 - (firstMathPart / secondMathPart), 0.5)) < 0.1
                        ? 0.1
                        : Math.min(1 - (Math.pow(1 - (firstMathPart / secondMathPart), 0.5)), 0.4)
                        : 1 - (Math.pow(1 - (thirdMathPart / secondMathPart), 0.5)) < 0.1
                        ? 0.1
                        : Math.min(1 - (Math.pow(1 - (thirdMathPart / secondMathPart), 0.5)), 0.4);
                Log.d("checkMath", "mathId_1008() -> try{} id_1008_value == " + id_1008_value);
                id_1008_value_string = Double.isNaN(id_1008_value) ? context.getString(R.string.not_valid_cut) : formatNumberDecimal(id_1008_value) + "";
            } else {
                id_1008_value_string = context.getString(R.string.not_valid_cut);
            }
        } catch (ArithmeticException | NumberFormatException e){
            id_1008_value = 0.0;
            id_1008_value_string = context.getString(R.string.not_valid_cut);
            Log.d("checkMath", "mathId_1008() -> catch{} id_1008_value == " + id_1008_value);
            e.printStackTrace();
        }
        Log.d("checkMath", "mathId_1008() -> id_1008_value == " + id_1008_value + "; id_1018_value == " + id_1018_value + "; id_7_value == " + id_7_value + "; id_5_value == " + id_5_value + "; id_11_value == " + id_11_value);
        return id_1008_value_string;
    }

    public String mathId_1009(){
        Log.d("checkMath", "mathId_1009 -> id_1004_value == " + id_1004_value + "; id_1_value == " + id_1_value);
        id_1009_value_string = id_1004_value > id_1_value ? "x<tf" : "x>tf";
        return id_1009_value_string;
    }

    public String mathId_1015(){
        id_1015_value = 0.64 * ((id_1002_value - id_6_value) * id_1001_value * (id_7_value - (id_1001_value / 2)) + 0.5 * id_6_value * id_7_value * id_7_value) * id_9_value / 1000;
        Log.d("checkMath", "mathId_1015 -> id_1015_value == " + id_1015_value + "; id_1002_value == " + id_1002_value + "; id_6_value == " + id_6_value + "; id_1001_value == " + id_1001_value + "; id_7_value == " + id_7_value + "; id_9_value == " + id_9_value);
        return formatNumberDecimal(Double.parseDouble(getTonOrKnVal(id_1015_value))) + "";
    }


    public String mathId_1016(){
        Log.d("checkMath", "mathId_1016 -> id_15_value == " + id_15_value + "; id_1_value == " + id_1_value);
        return id_1015_value * 2 > id_1_value ? context.getString(R.string.valid_cut) : context.getString(R.string.not_valid_cut);
    }


    public String mathId_1017(){
        id_1017_value_string = id_1015_value > id_1_value ? context.getString(R.string.pressure_not_required) : context.getString(R.string.pressure_required);
        Log.d("checkMath", "mathId_1017() -> id_1017_value_string == " + id_1017_value_string + "; id_1015_value == " + id_1015_value + "; id_1_value == " + id_1_value);
        return id_1017_value_string;
    }

    public String mathId_1018(){
        Log.d("checkMath", "mathId_1016 -> id_1015_value == " + id_1015_value + "; id_1_value == " + id_1_value);
        id_1018_value = id_17_value_string.equals(context.getString(R.string.pressure_required)) ? id_1_value - id_1015_value : 0.0;
        return id_17_value_string.equals(context.getString(R.string.pressure_required)) ? (formatNumberDecimal(Double.parseDouble(getTonOrKnVal(id_1_value - id_1015_value)))) +"": context.getString(R.string.pressure_not_required);
    }

    public String mathId_1019(){
        id_1019_value = 0.0;
        if (id_17_value_string.equals(context.getString(R.string.pressure_required))){
            firstMathPart = id_1018_value * 1000 * 1000;
            secondMathPart = (id_7_value - id_5_value) * id_11_value * 10;
            try {
                if (secondMathPart == 0) throw new NumberFormatException(DIVIDE_BY_ZERO_EXCEPTION);
                id_1019_value = firstMathPart / secondMathPart / 100;
                id_1019_value = Double.isNaN(id_1019_value) ? 0.0 : id_1019_value;
                Log.d("checkMath", "mathId_1019() -> try{} id_1019_value == " + id_1019_value);
            } catch (ArithmeticException | NumberFormatException e){
                id_1019_value = 0.0;
                Log.d("checkMath", "mathId_1019() -> catch{} id_1019_value == " + id_1019_value);
                e.printStackTrace();
                return context.getString(R.string.not_valid_cut);
            }
        }
        Log.d("checkMath", "mathId_1019() -> id_1019_value == " + id_1019_value + "; id_1018_value == " + id_1018_value + "; id_7_value == " + id_7_value + "; id_5_value == " + id_5_value + "; id_11_value == " + id_11_value);
        return formatNumberDecimal(id_1019_value) +"";
    }

    public String mathId_1021(){
        firstMathPart = 2 * id_1_value * 1000;
        secondMathPart = id_1002_value * id_7_value * id_7_value * id_9_value;
        Log.d("checkMath", "mathId_1021() -> firstPart == " + firstMathPart + "; secondPart == " + secondMathPart + "; allParts == " + (1-(Math.pow(1-((firstMathPart) / (secondMathPart)),0.5))));
        try {
            if (secondMathPart == 0) throw new NumberFormatException(DIVIDE_BY_ZERO_EXCEPTION);
            id_1021_value = 1-(Math.pow(1-((firstMathPart) / (secondMathPart)),0.5)) < 0.1
                    ? 0.1
                    : Math.min(1 - (Math.pow(1 - ((firstMathPart) / (secondMathPart)), 0.5)), 0.4);
            if (Double.isNaN(id_1021_value)) throw new NumberFormatException(NaN);
            return formatNumberDecimal(id_1021_value) + "";
        } catch (NumberFormatException e){
            e.printStackTrace();
            id_1021_value = Double.NaN;
            return context.getString(R.string.not_valid_cut);
        }
    }

    public String mathId_1022(){
        Log.d("checkMath", "mathId_1022 -> id_1004_value == " + id_1004_value + "; id_1_value == " + id_1_value + "; id_1007_value == " + id_1007_value + "; id_1021_value == " + id_1021_value + "; id_7_value == " + id_7_value);
        try {
            if (id_1004_value > id_1_value){
                if (Double.isNaN(id_1007_value)) throw new NumberFormatException(NaN);
                id_1022_value = id_1007_value * id_7_value;
                Log.d("checkMath", "mathId_1022 -> id_1022_value == " + id_1022_value + "; id_1004_value == " + id_1004_value + "; id_1007_value == " + id_1007_value + "; id_7_value == " + id_7_value + "; id_1_value == " + id_1_value);
                return formatNumberDecimal(id_1022_value);
            } else {
                if (Double.isNaN(id_1021_value)) throw new NumberFormatException(NaN);
                id_1022_value = id_1021_value * id_7_value;
                Log.d("checkMath", "mathId_1022 -> id_1022_value == " + id_1022_value + "; id_1004_value == " + id_1004_value + "; id_1021_value == " + id_1021_value + "; id_7_value == " + id_7_value + "; id_1_value == " + id_1_value);
                return formatNumberDecimal(id_1022_value);
            }
        } catch (NumberFormatException e){
            return context.getString(R.string.not_valid_cut);
    ...
    public String mathId_1023(){
        Log.d("checkMath", "mathId_1023 -> id_1021_value == " + id_1021_value);
        if (Double.isNaN(id_1021_value)){ return context.getString(R.string.not_valid_cut); }
        id_1023_value = Math.min((1 - (id_1021_value / 2)) * id_7_value, 0.95 * id_7_value);
        Log.d("checkMath", "mathId_1023 -> id_1023_value == " + id_1023_value + "; id_1021_value == " + id_1021_value + "; id_7_value == " + id_7_value);
        return formatNumberDecimal(id_1023_value);
    }

    public String mathId_1024(){
        try {
            if (Double.isNaN(id_21_value) || Double.isNaN(id_1007_value)) throw new NumberFormatException(NaN);
            id_1024_value = id_17_value_string.equals(context.getString(R.string.pressure_required)) && id_1009_value_string.equals("x<tf")
                    ? id_1019_value + id_1015_value * 1000 / ((1 - id_21_value * 0.5) * id_7_value * id_11_value)
                    : id_17_value_string.equals(context.getString(R.string.pressure_required))
                    ? ((id_1005_value * 1000 * 1000) / (id_23_value * id_11_value * 10)) / 100 + id_16_value + (id_1_value - id_1005_value) * 1000 / ((1 - id_1007_value * 0.5) * id_7_value * id_11_value)
                    : id_17_value_string.equals(context.getString(R.string.pressure_required)) && id_1009_value_string.equals("x>tf")
                    ? ((id_1004_value * 1000) / ((id_7_value - id_1001_value * 0.5) * id_11_value)) + (id_1_value - id_1005_value) * 1000 / ((1 - id_1007_value * 0.5) * id_7_value * id_11_value)
                    : id_1009_value_string.equals("x<tf") ? ((id_1_value * 1000) / ((1 - id_21_value * 0.5) * id_11_value * id_7_value))
                    : 0;
            Log.d("checkMath", "mathId_1024 -> id_1024_value == " + id_1024_value + "; id_17_value_string == " + id_17_value_string + "; id_1009_value_string == " + id_1009_value_string);
            Log.d("checkMath", "mathId_1024 -> id_1019_value == " + id_1019_value + "; id_1015_value == " + id_1015_value + "; id_21_value == " + id_21_value + "; id_7_value == " + id_7_value);
            Log.d("checkMath", "mathId_1024 -> id_1005_value == " + id_1005_value + "; id_23_value == " + id_23_value + "; id_11_value == " + id_11_value + "; id_16_value == " + id_16_value + "; id_1_value == " + id_1_value + "; id_1007_value == " + id_1007_value);
            if (Double.isNaN(id_1024_value)) throw new NumberFormatException(NaN);
            return formatNumberDecimal(id_1024_value);
        } catch (NumberFormatException e){
            id_1024_value = Double.NaN;
            Log.d("checkMath", "mathId_1024 == " + context.getString(R.string.not_valid_cut));
            return context.getString(R.string.not_valid_cut);
        }
    }

    public String mathId_1031(){
        if (Double.isNaN(id_1024_value)) { return context.getString(R.string.not_valid_cut); }
        Log.d("checkMath", "mathId_1009 -> id_1004_value == " + id_1004_value + "; id_1_value == " + id_1_value);
        return id_29_value > id_1024_value ? context.getString(R.string.armament_cut_dose_is_valid) : context.getString(R.string.armament_cut_dose_is_not_valid);
    }

    public void valueNumberChangedListener(double valueItemNumber, int valueItemId, int spinnerPosition) {
        Log.d("changedListener", "BendingToleranceCategory{} -> valueItemNumber == " + valueItemNumber + "; id == " + valueItemId);
        switch (valueItemId){
            case 1:
                id_1_value = valueItemNumber;
                setRelevantResultItem_value(1016, mathId_1016(), "");
                setRelevantResultItem_value(1017, mathId_1017(), "");
                setRelevantResultItem_value(1018, mathId_1018(), "");
                setRelevantResultItem_value(1019, mathId_1019(), "");
                setRelevantResultItem_value(1021, mathId_1021(), "");
                setRelevantResultItem_value(1008, mathId_1008(), "");
                setRelevantResultItem_value(1009, mathId_1009(), "");
                setRelevantResultItem_value(1022, mathId_1022(), "");
                setRelevantResultItem_value(1023, mathId_1023(), "");
                setRelevantResultItem_value(1024, mathId_1024(), "");
                setRelevantResultItem_value(1031, mathId_1031(), "");
                break;
            case 2:
                ...
                setRelevantResultItem_value(1015, mathId_1015(), "");
                setRelevantResultItem_value(1016, mathId_1016(), "");
                setRelevantResultItem_value(1004, mathId_1004(), "");
                setRelevantResultItem_value(1005, mathId_1005(), "");
                setRelevantResultItem_value(1006, mathId_1006(), "");
                setRelevantResultItem_value(1007, mathId_1007(), "");
                setRelevantResultItem_value(1008, mathId_1008(), "");
                setRelevantResultItem_value(1009, mathId_1009(), "");
                setRelevantResultItem_value(1017, mathId_1017(), "");
                setRelevantResultItem_value(1018, mathId_1018(), "");
...
//                }
            ...
            case 3:
                ...
                setRelevantResultItem_value(1015, mathId_1015(), "");
                setRelevantResultItem_value(1016, mathId_1016(), "");
                setRelevantResultItem_value(1003, mathId_1003(), "");
                setRelevantResultItem_value(1004, mathId_1004(), "");
                setRelevantResultItem_value(1005, mathId_1005(), "");
                setRelevantResultItem_value(1006, mathId_1006(), "");
                setRelevantResultItem_value(1007, mathId_1007(), "");
