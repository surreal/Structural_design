...
public class PenetrationCategory_SubCategoryFour extends PenetrationCategory {

    public PenetrationCategory_SubCategoryFour(){
        resetValues();
        setValues();
        setAllAdapters();
        resetValuesLocal();
    ...
    private void setValues() {
        if (savedVersionTitle != null) {
            ...
            id_105_value = sqlLocal.getRelevantDoubleValue(cursor, null, DBModel.COLUMN_VAL_ID_105);
        ...
        Log.d("checkSetValues", "id_25_value == " + id_25_value + "; id_25_position == " + id_25_position);
    ...
    private ArrayList<StructuralDesignModel> initModels(boolean isForSetValuesModels) {
        if (isForSetValuesModels){
            ...
            valuesModels.add(new StructuralDesignModel(104, "מימדי עמוד מלבני", "גודל עמוד בכיוון ניצב לקצה", "[cm]", id_104_value+"", 0));
            valuesModels.add(new StructuralDesignModel(105, "מימדי עמוד מלבני", "גודל עמוד בכיוון מקביל לקצה", "[cm]", id_105_value+"", 0));
            valuesModels.add(new StructuralDesignModel(106, "מרחק הקצר ביותר מפני עמוד לפני השפה", "", "[cm]", id_105_value+"", 0));
            ...
            resultModels.add(new StructuralDesignModel(31, "היקף קריטי ראשון", "U,1", "[сm]", mathId_31(1), 0));
            ...
            resultModels.add(new StructuralDesignModel(58, "מרחק קו קריטי U1 מפני העמוד", "R,U1", "[сm]", mathId_58(2), 0));
            resultModels.add(new StructuralDesignModel(59, "מרחק היקף  קריטי  שני  מפני העמוד", "R,U2", "[сm]", mathId_59(2), 0));
            ...
            resultModels.add(new StructuralDesignModel(2000, "היקף קו היקפי", "сm", "", mathId_2000(id_25_value == 1.4 ? 0.75 : 0.5), 0));
    ...
    private String mathId_108() {
        try {
            id_108_value = (id_25_value == 1.4
                    ? (id_105_value > id_104_value
                    ? (Math.min(2 * id_104_value, Math.min(id_105_value, 3 * id_7_value)) +
                    Math.min(id_104_value, 3 * id_7_value)) * 2 - id_105_value + (id_106_value > 0 ? (id_105_value > id_106_value
                    ? 2 * id_106_value : id_105_value) : 0) : (Math.min(2 * id_105_value, Math.min(id_104_value, 3 * id_7_value)) +
                    Math.min(id_105_value, 3 * id_7_value)) * 2) - id_105_value + (id_106_value > 0 ? (id_105_value > id_106_value ? 2 *
                    id_106_value : id_105_value) : 0) : (id_104_value > id_104_value ?
                    (Math.min(2 * id_104_value, Math.min(id_105_value, 3 * id_7_value)) +
                            Math.min(id_104_value, 3 * id_7_value)) * 2 - id_105_value - id_104_value +
                            (id_106_value > 0 ? (id_105_value > id_106_value ? 2 * id_106_value : 2 * Math.min(id_105_value, id_104_value)) : 0)
                    : (Math.min(2 * id_105_value,Math.min(id_104_value, 3 * id_7_value)) + Math.min(id_105_value, 3 * id_7_value)) * 2) -
                    id_105_value - id_104_value + (id_106_value > 0 ? (id_105_value > id_106_value ? 2 * id_106_value
                    : 2 * Math.min(id_105_value,id_104_value)):0));
            Log.d("checkMath", "mathId_108 -> id_108_value == " + id_108_value +"; id_103_value == " + id_103_value);
    ...
    private void insertToDB() {
        sqLiteDatabase.execSQL(sqlHelper.insertPenetration_SQL(DialogHelper.input, moduleActiveId, categoryActiveId, subCategoryActiveId,
                ...
                1, 1, 1,  id_104_value, id_105_value, id_106_value,1,
